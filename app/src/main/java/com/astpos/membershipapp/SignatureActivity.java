...
public class SignatureActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File file = new File("waiver_form.doc");
//        PDDocument doc = PDDocument.load(file);

        Log.d(TAG, file.getPath());

//        DIRECTORY = Environment.getExternalStorageDirectory().getPath() + "/UserSignature/"; //getCacheDir() + "/UserSigniture/";
        DIRECTORY = getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS).getPath();

        Log.d(TAG, "DIRECTORY: " + DIRECTORY);
        Log.d(TAG, "DATA DIR: " + Environment.getDataDirectory());
        Log.d(TAG, "ROOT DIR: " + Environment.getRootDirectory());
...
//        pic_name = new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.getDefault()).format(new Date());
    ...
    protected void onResume(){
        super.onResume();
//        Log.d(MainActivity.TAG, "SignatureActivity  resumed");
    }

    @Override
    protected void onPause(){
        super.onPause();
//        Log.d(MainActivity.TAG, "SignatureActivity paused");
    }

    @Override
    protected void onStop(){
        super.onStop();
//        Log.i(MainActivity.MainActivity.TAG, "SignatureActivity stop");
    }

    @Override
    protected void onDestroy(){
        super.onDestroy();
//        Log.d(MainActivity.TAG, "SignatureActivity destroyed");
    }
